                ...
                <van-swipe-cell>
                    ...
                    <div class="goods-info">
                        ...
                        <div class="bottom">
                            ...
                            <van-stepper v-model="item.cart.num" theme="round" button-size="22" :before-change="beforeChange" disable-input />
                        </div>
                    </div>
                    <!-- 左滑删除 -->
                    <template #right>
...
const loadCart = async () => {
    ...
    let {results} = await request.get('/1.1/classes/goods?where='+JSON.stringify(query))
